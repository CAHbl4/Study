...
/*
 * Домашнее задание №3 к модулю 8
 *
 * Из-за несоотвествия кодировок в исходном файле и в консоли, а также из-за невнятного расположения русских
 * символов в 866-й кодировке, которое просто увеличвает количество строк кода в функциях и не дает ничего взамен
 * все функции были написаны и протестированы только для латиницы.
 *
 * Все функции вынесены в отдельные файлы для лучшей навигации. Одноразовые функции которым не нашлось места в
 * библиотеке остались в "главном" файле.
 *
 * Из-за невнятной нумерации заданий все задания выполнены в одном файле.
 *
 * a.matuzov, 29.03.2016
 */
...
void func_311()
{
	...
	size_t pos = (size_t)read_int(stdin);
